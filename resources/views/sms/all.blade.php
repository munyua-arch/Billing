        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('sms.sendAll') }}" autocomplete="off" id="smsForm2">
                            @csrf
                            
                            <h6 class="heading-small text-muted mb-4">SMS Details For All</h6>
...
@push('js')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const form = document.getElementById('smsForm2');
