                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h2 font-weight-bold mb-0">KSH 350,897.00</span>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h2 font-weight-bold mb-0">KSH 20,000.00</span>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h2 font-weight-bold mb-0">KSH 3,500.00</span>
                                </div>
                                <div class="col-auto">
